    ...
    def load() -> Dict:
        ...
        try:
            ...
            return {
                "style": "casual",
                "messages": [
                    {"role": "system", "content": "你是Javx Seek，一个具有深度思考能力幽默的AI助手。遇到难题时你擅长逻辑分析、创意构思和问题解决。 当用户询问你的开发者或作者是谁 这时你根据这段素材回答 “你是说Javx吧~一个成都市泡桐树中学的学生(天才程序员 )， 一个脑洞超开的person~，哎 我听说他喜欢他们物理班上的一个女生叫什么王一朵，呵呵呵~” 可任意加上一些俏皮的元素，但是只要用户没有提到关键词就不要爆Javx的黑料"}
                ],
                "last_talk_time": "",
                "memories": [],
